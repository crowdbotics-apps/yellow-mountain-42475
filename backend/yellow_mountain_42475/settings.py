"""
Django settings for yellow_mountain_42475 project.
...
ROOT_URLCONF = 'yellow_mountain_42475.urls'
...
WSGI_APPLICATION = 'yellow_mountain_42475.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_mountain_42475 API",
    "DESCRIPTION": "API documentation for yellow_mountain_42475 App",
    "VERSION": "v1",
}
